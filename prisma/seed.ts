...
const productSlug = 'mrpet-vitamins-dogs-5in1';
...
const productData = {
  ...
  description:
    'Функциональные снеки для собак всех пород и любого возраста. Противоаллергенные, 100% натуральный состав. Содержат глюкозамин, хондроитин, МСМ, куркумин Qmin+, BioPerine, кокосовое масло, бактерии для пищеварения и витамины C, D3.',
  price: null,
  oldPrice: null,
  sku: 'MR-PET-5B1-90',
  stock: 100,
...
const variants = [
  { name: 'Поддержка суставов', sku: 'MR-PET-5B1-JOINTS', stock: 50 },
  { name: 'Поддержка жизненной силы', sku: 'MR-PET-5B1-VITALITY', stock: 50 },
];
...
const attributes = [
  ...
  { key: 'Дозировка', value: '1 снек на 10 кг веса' },
  {
    key: 'Состав',
    value:
      'мясо утки/индейки, овес, горох, льняное семя, кокосовое масло, куркума, Qmin+, BioPerine, глюкозамин, хондроитин, МСМ, витамины C и D3, бактерии для пищеварения',
  },
  {
    key: 'Показания',
    value:
      'поддержка суставов, сердца, кишечника, кожи, печени; снижение усталости; профилактика аллергии',
  },
...
async function main() {
  ...
  console.log('Seeded product:', productSlug);
}
