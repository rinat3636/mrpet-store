...
async function main() {
  await prisma.product.upsert({
    ...
    create: {
      ...
      description: 'Функциональные снеки для собак всех пород и любого возраста. Со вкусом утки. Противоаллергенные, 100% натуральный состав, высокая дозировка 500 мг. Содержат глюкозамин, хондроитин, МСМ, куркумин Qmin+, BioPerine, кокосовое масло, бактерии для пищеварения и витамины C, D3.',
      price: null,
      oldPrice: null,
      sku: 'MR-PET-5B1-90',
      stock: 100,
