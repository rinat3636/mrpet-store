...
async function main() {
  await prisma.product.upsert({
    ...
    create: {
      ...
      description: 'Функциональные снеки для собак всех пород и любого возраста. Противоаллергенные, 100% натуральный состав. Содержат глюкозамин, хондроитин, МСМ, куркумин Qmin+, BioPerine, кокосовое масло, бактерии для пищеварения и витамины C, D3.',
      price: null,
      oldPrice: null,
      sku: 'MR-PET-5B1-90',
      stock: 100,
      ...
      attributes: {
        create: [
          ...
          { key: 'Состав', value: 'мясо утки/индейки, овес, горох, льняное семя, кокосовое масло, куркума, Qmin+, BioPerine, глюкозамин, хондроитин, МСМ, витамины C и D3, бактерии для пищеварения' },
